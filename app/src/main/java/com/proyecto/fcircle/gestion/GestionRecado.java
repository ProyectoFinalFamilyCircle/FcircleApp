...
*/
        public String post(String urlPeticion) {
            ...
            try {
                ...
                multipartEntity.addPart("titulo", new StringBody("aa"));
                multipartEntity.addPart("descripcion", new StringBody("bb"));
                multipartEntity.addPart("usuarioCreador", new StringBody("cc"));
                multipartEntity.addPart("usuarioReceptor", new StringBody("eee"));
